...
function Introduction() {
  return (
    ...
    >
      <p>
        <code>@dwc/core</code> boots three cooperating Web Workers behind one call — a kernel worker that routes
...
// { output: "/project\\n", cwd: "/project" }`}
      ...
      <p>
        <code>await bootDWC()</code> still works too — <code>await</code> on a plain object that isn't a Promise just
