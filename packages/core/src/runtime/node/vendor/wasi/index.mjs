// VENDORED VERBATIM from @tybys/wasm-util v0.10.1 — lib/mjs/wasi/index.mjs (MIT)
// Source: https://github.com/toyobayashi/emnapi/tree/main/packages/wasm-util
// A real, complete WASI preview1 implementation with a pluggable Node-fs-shaped
// `options.fs` backend - not a Node builtin itself, but the same class shape
// (.wasiImport/.initialize()/.start()) real Node's own `node:wasi` exposes.
// Used here (see ../../builtins/wasi.ts) instead of hand-writing the preview1
// syscall/struct-encoding layer from scratch: the fs.ts's own adapter
// (createWasiFsAdapter in wasi.ts) is the only new code, translating this
// package's Node-fs-shaped calls onto this project's existing sync fs bridge.
// Do not edit the body (util.mjs/path.mjs/rights.mjs/types.mjs/error.mjs/
// fd.mjs/preview1.mjs alongside this file are the same vendored package).
